...
#######
    ...
    self.carRearWheelDist = 0.25 * self.length #Origin is 1 quarter of the length from the rear of the car
    self.carCcolor = 0,0,0              #black
    self.carLineWidth = 3
